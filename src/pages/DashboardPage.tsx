...
function AttentionCard({
  ...
  return (
    <Reveal delay={index * 50}>
      <Link
        to={to}
        className="attention-card card-halo group flex items-center gap-4 rounded-2xl border border-line bg-surface p-4 shadow-float transition-all hover:-translate-y-1 hover:border-brand-accent hover:shadow-overlay focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand"
      >
        <span
...
function StatCard({
  ...
  return (
    <Reveal delay={index * 50}>
      <Link
        to={to}
        className="stat-card card-halo block rounded-2xl border border-line bg-surface p-5 shadow-float transition-all hover:-translate-y-1 hover:scale-[1.02] hover:border-brand-accent hover:shadow-overlay focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand"
      >
        <span
