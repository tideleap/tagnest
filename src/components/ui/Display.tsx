...
/* ------------------------------------------------------------------ *
 * ColorPicker — shared tag/colour swatch selector (D1)
 * ------------------------------------------------------------------ */
...
/* ------------------------------------------------------------------ *
 * DialogFooter — shared cancel/confirm button pair (D1)
 * ------------------------------------------------------------------ */
...
/* ------------------------------------------------------------------ *
 * QueryErrorState — the honest counterpart of EmptyState
 * ------------------------------------------------------------------ */

/**
 * Rendered when a list query FAILS. Deliberately distinct from EmptyState:
 * a failed load must never read as "there is no data" — that confusion hides
